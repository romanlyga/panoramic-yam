...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/60058dd489979d001794960f
...
To start editing your site, you can use the Sanity interface at https://panoramic-yam-58dd4.sanity.studio/.
...
Generated at `2021-01-18T13:32:20.760Z` by Stackbit version `0.3.43-staging.0`.